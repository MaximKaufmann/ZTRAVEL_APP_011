...
CLASS lhc_travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  PRIVATE SECTION.
    ...
    TYPES tt_travel_update TYPE TABLE FOR UPDATE zi_011_travel.
...
********************************************************************************
  METHOD get_features.
    ...
    READ ENTITY zi_011_travel FROM VALUE #( FOR keyval IN keys
                                                      (  %key                    = keyval-%key
...
********************************************************************************************************************************************
  METHOD validate_agency.
    ...
    READ ENTITY zi_011_travel\\travel FROM VALUE #(
...
METHOD set_status_completed.
  ...
  MODIFY ENTITIES OF zi_011_travel IN LOCAL MODE
         ENTITY travel
  ...
  READ ENTITIES OF zi_011_travel IN LOCAL MODE
       ENTITY travel
...
METHOD calculatetravelkey.
  ...
  "Get max travelID
  SELECT SINGLE FROM z011_travel FIELDS MAX( travel_id ) INTO @DATA(lv_max_travelid).
