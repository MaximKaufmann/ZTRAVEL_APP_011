CLASS zcl_011_generate_travel_data DEFINITION
PUBLIC
FINAL
CREATE PUBLIC .
  PUBLIC SECTION.
...
CLASS zcl_011_generate_travel_data IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA itab TYPE TABLE OF z011_travel.
...
DELETE FROM z011_travel.
out->write( |Removed { sy-dbcnt } entries from travel table.| ).
* insert the new table entries
INSERT z011_travel FROM TABLE @itab.
